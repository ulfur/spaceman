...
2. Place **Testbed [9]** on the service network. It costs 30 metal and 5 components, with 16 base construction hours adjusted by service efficiency.
3. Select the finished chamber and choose **Open field trial**, or use **Field trials** from the surface, orbit or observatory.
...
| Atmosphere: regulating / sealed | Run native-gas intake, venting and CO₂ separation, or close the isolation valves |
...
| Graph selectors | Inspect measured temperature, pressure or live biomass; samples are retained every six logical hours |
