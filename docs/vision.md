...
Use one planetary engineering objective with several plausible industrial approaches. The player should make consequential placement and production decisions, see a bottleneck, revise a plan, and watch a real output influence the planetary problem. The existing ship journey can remain available as the test of autonomy.
