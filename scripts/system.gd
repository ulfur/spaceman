...
func _ready() -> void:
	...
	heading.add_child(UI.label("SYSTEM NAVIGATION", 26))
	...
	rail.add_child(UI.button("−", func(): map.universe.zoom(1.5), "NavZoomOut"))
	rail.add_child(UI.button("+", func(): map.universe.zoom(1.0 / 1.5), "NavZoomIn"))
	rail.add_child(UI.button("Focus target", map.frame_body, "FocusContact"))
	rail.add_child(UI.button("System", map.recenter, "FrameSystem"))
